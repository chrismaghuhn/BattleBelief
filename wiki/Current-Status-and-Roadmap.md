...
- measured M1.5 acceptance evidence with Selection, Power Pilot, and Release
  Holdout access unopened. See the [M1.5 measurement evidence](https://github.com/chrismaghuhn/BattleBelief/blob/main/docs/operations/m1-5-measurement-harness-evidence.md).
